...
present <- present %>% mutate(prob_boys=boys/total)
ggplot(data = present, aes(x = year, y = prob_boys)) +geom_line() + geom_point()
```
...
ggplot(data = present, aes(x = year, y = prob_boy_girl)) +geom_line() + geom_point()
